...
namespace Test1.EF_Core
{
    class Main1
    {
        // To see the queries in SQL Server Profile:
        // _ In properties -> General -> Use the template: Blank
        // _ In properties -> Events Selection  -> Stored Procedures -> RCP:Completed
        ...
        private async Task CreateTheDatabaseAsync()
        {
            using (var context = new BooksContext())
            {
                ...
                Console.WriteLine(created ? "Created" : "Exists");
            }
        }
